...
Status: **independent development candidate; local tests pass; Windows CI and Studio Pro pending**.
...
- Local Cluster and keyswitch tests: passed. Windows CI: pending. Studio Pro: pending `docs/0.4i-HOST-CHECKLIST.md`.
