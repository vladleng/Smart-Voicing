...
Windows CI запущен для актуальной ветки после этих изменений. Итог CI ещё не подтверждён. Версия 0.2e остаётся **В РАБОТЕ** до зелёного CI и пользовательского теста в Studio Pro.
