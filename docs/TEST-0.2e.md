...
Текущий HEAD: `4f8aa208b5e6ba93eb50797bab9d531eb2442cc3`.

Windows Build **#218** запущен для актуального HEAD. На момент обновления документа выполняется `Configure`; итог CI ещё не подтверждён. Версия 0.2e остаётся **В РАБОТЕ** до зелёного CI и пользовательского теста в Studio Pro.
