...
{
// 0.4c4 fix1 realtime selector for the existing shared VoicingType state.
//
...
constexpr int kDrop3ReservedVoicingKeyswitchNote = 38;
constexpr int kDrop24ReservedVoicingKeyswitchNote = 39;
